...
def PurgeLiveMatch():
    ...
    requete.execute('''DELETE FROM PROD_LIVE_MATCH_HISTO''')
    requete.execute('''DELETE FROM PROD_REF_PLAYERS''')
...
def AddData_LIVE(id_match,b1,b2,r1,r2,time_start,time_goal,score_b,score_r):
    requete.execute('''INSERT INTO PROD_LIVE_MATCH (id_match,b1,b2,r1,r2,time_start,time_goal,score_b,score_r)
...
def AddData_HISTO(id_match,b1,b2,r1,r2,time_start,time_goal,score_b,score_r):
    requete.execute('''INSERT INTO PROD_LIVE_MATCH_HISTO (id_match,b1,b2,r1,r2,time_start,time_goal,score_b,score_r)
    VALUES (?,?,?,?,?,?,?,?,?)''',(id_match,b1,b2,r1,r2,time_start,time_goal,score_b,score_r))
def AddData_PLAYER(id_player,firstname,lastname,nickname):
    requete.execute('''INSERT INTO PROD_REF_PLAYERS (id_player,firstname,lastname,nickname)
...
print('\n PROD_LIVE_MATCH')
requete.execute('SELECT * FROM PROD_LIVE_MATCH')
for i in requete:
    print ('\n')
    for j in i:
        print (j)
        
print('\n PROD_LIVE_MATCH_HISTO')
requete.execute('SELECT * FROM PROD_LIVE_MATCH_HISTO')
for i in requete:
    print ('\n')
    for j in i:
        print (j)
...
print('\n PROD_REF_PLAYERS')
requete.execute('SELECT * FROM PROD_REF_PLAYERS')
for i in requete:
    print ('\n')
    for j in i:
        print (j)
...
print('\n PROD_REF_COMMENTS')
requete.execute('SELECT * FROM PROD_REF_COMMENTS')
for i in requete:
    print ('\n')
    for j in i:
        print (j)
