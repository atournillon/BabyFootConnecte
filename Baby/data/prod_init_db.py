...
try:
    ...
    def CreateTable():
        ...
        (id_player INTEGER, match_count INTEGER, match_win_count INTEGER, match_los_count INTEGER, game_time_sec INTEGER,
         ...
         , prenom TEXT , nom TEXT , trigram TEXT, bad_los_score INTEGER, best_win_score INTEGER,mean_score INTEGER, ranking INTEGER,
         best_partner INTEGER,bad_partner INTEGER,bad_adver INTEGER,best_adver INTEGER)''')
